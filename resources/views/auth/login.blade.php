...
@section('content')
    <div class="mdl-typography--text-center auth-form auth-form__bg-container">
        <div class="auth-form__bg-overlay">
            <h3 class="text--light reveal reveal-top">Login</h3>

            <h4 class="text--light reveal reveal-bottom">Get goodies by logging in to our website!</h4>
            ...
            <div class="auth-form__container">
                {!! Form::open(['url' => '/login','method' => 'POST']) !!}
                    ...
                    <div class="checkbox-container reveal reveal-left">
                    ...
                    <input type="submit" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent mdl-js-ripple-effect reveal reveal-bottom-delay-250" value="Login" />
                ...
                <a href="#" class="text--color-white reveal reveal-bottom-delay-500">Forgot password?</a>   <a href="{{ url('/register') }}" class="text--color-white reveal reveal-bottom-delay-500">Don't have an account?</a>
            </div>
        </div>
    </div>
@stop