...
@section('content')
    <div class="hero hero--home">
        <div class="hero__content-container">
                <h1 class="reveal-top">Oh! Hi there.<br />In case you're wondering, We provide you with <span class="text--normal">HSEB Plus Two</span> <span class="text--color-accent">Notes</span>, <span class="text--color-accent">News</span> &amp; <span class="text--color-accent">References</span>.</h1>
                <h2 class="reveal-bottom-delay-250">Browse our rich and easy notes or go through syllabus to better manage your studying. Ready to dive in?</h2>
                <a href="{{ route('posts.index') }}" class="hero__btn mdl-button mdl-js-button mdl-button--raised mdl-button--primary mdl-js-ripple-effect reveal-right-delay-500">Read what we got</a>
                <h6 class="text--light mdl-typography--text-center reveal-top">
                    You said "Make it easier for me!"? We gottcha. <br>
                    <span class="text--normal">You are in...</span>
                </h6>
                @foreach($grades as $grade)
                    <a href="{{ route('posts.index.grade',['grades' => $grade->grade_name]) }}" class="hero__btn mdl-button mdl-js-button mdl-button--primary mdl-js-ripple-effect reveal-bottom">Grade {{ $grade->grade_name }}</a>
                @endforeach

        </div>
        <div class="hero__img-container">
            <div class="hero__img reveal-bottom-delay-1000">
    ...
    <section class="section section--intro mdl-grid">
        <div class="mdl-cell mdl-cell--12-col section--center mdl-typography--text-left">
            <h1 class="section__heading reveal-left">
                Plus Two Notes
            ...
            <div class="section__body mdl-grid">
                <div class="mdl-cell mdl-cell--5-col">
                    <div class="section--intro__img reveal-left-delay-500">
                ...
                <div class="mdl-cell mdl-cell--7-col mdl-typography--text-justify">
                    <p class="reveal-right-delay-250">
                    ...
                    <p class="reveal-bottom-delay-500">
            ...
            <div class="section__body">
                ...
                <div class="mdl-typography--text-center">
                    <img src="{{ asset('img/browser_mockup.png') }}"
                         class="section--future__browser-mockup reveal-bottom-delay-250"
