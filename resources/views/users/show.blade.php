...
@section('content')
                ...
                <div class="mdl-grid">
                    <div class="mdl-cell mdl-cell--3-col">
                        <div class="user-profile__avatar-container mdl-typography--text-center">
                            <img src="{{ $user->avatar_large }}" alt="{{ $user->name }}" class="user-profile__avatar-img img--circular reveal reveal-left" />
                        </div>
                    </div>
                    <div class="mdl-cell mdl-cell--9-col">
                        <h3 class="user-profile__name text--light reveal reveal-right">
                            {{ $user->name }}
                            <small>
                                {
                        ...
                        <div class="user-profile__details reveal reveal-right-delay-250">
    ...
    <div class="mdl-grid section--center">
        <div class="mdl-cell mdl-cell--12-col">
            <h3 class="text--thin reveal reveal-top">User Contributions</h3>
        </div>
    </div>
@stop