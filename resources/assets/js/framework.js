...
(function ( factory ) {
    ...
    DatePicker.prototype.nodes = function( isOpen ) {
        ...
        return _.node(
            ...
            _.node(
                'div',
                _.node( 'button', settings.today, "mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--accent picker__today",
                    'type=button data-pick=' + nowObject.pick +
                    ( isOpen && !calendar.disabled(nowObject) ? '' : ' disabled' ) + ' ' +
                    _.ariaAttr({ controls: calendar.$node[0].id }) ) +
                _.node( 'button', settings.clear, "mdl-button mdl-js-button mdl-js-ripple-effect picker__clear",
                    'type=button data-clear=1' +
                    ( isOpen ? '' : ' disabled' ) + ' ' +
                    _.ariaAttr({ controls: calendar.$node[0].id }) ) +
                _.node('button', settings.close, "mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--accent picker__close",
